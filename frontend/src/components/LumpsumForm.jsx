  ...
  return (
    <form onSubmit={submit} style={formStyle}>
      <div style={headerStyle}>
        ...
        <h2 style={headingStyle}>Lumpsum Calculator</h2>
        <p style={subStyle}>Calculate growth of a one-time investment.</p>
      </div>
      ...
      <p style={noteStyle}>Annual compounding | One-time investment</p>
    </form>
  );
}
