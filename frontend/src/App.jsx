      ...
      <header style={styles.header}>
        <div style={styles.headerInner}>
          <div style={styles.logoWrap}>
            ...
            <div>
              <div style={styles.logoText}>True<span style={styles.logoMFD}>MFD</span></div>
        ...
        <div style={styles.heroText}>
          ...
          <p style={styles.heroSub}>
            Plan your SIP, Lumpsum, Goal, SWP, PPF & more
          </p>
        </div>
      </header>
      ...
      <footer style={styles.footer}>
        <div style={styles.footerInner}>
          <div style={styles.footerBrand}>
            <strong>TrueMFD — True Mutual Fund Distributor</strong>
          </div>
          ...
          <div style={styles.footerAddress}>
            Block No. 108, 1st Floor, Haakim Arcade, Dharampeth Coffee House Square, Nagpur - 440010
          </div>
